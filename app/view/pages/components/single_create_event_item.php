    ...
    <div class="container text-center">
        <h3>CREATE EVENT</h3>
        <!-- NAME -->
        <form class="pt-5 createEvents" action="<?php echo BASE_URL ?>/manage/createEvent" method="post">
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row pt-4">
                    <div class="col-md-6">
                        <label for="cars">Choose a venues:</label>
                    </div>
        ...
        <!-- DATE START -->
                ...
                <div class="row pt-5">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="DateStart" id="datepicker" value="<?php if(isset($_POST['DateStart'])) echo $_POST['DateStart']?>"></input><br>
                        <?php 
        ...
        <!-- DURATION -->
                ...
                <div class="row pt-3">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="DateEnd" id="datepicker2" value="<?php if(isset($_POST['DateEnd'])) echo $_POST['DateEnd']?>"></input><br>
                        <?php 
