...
?>
                ...
                <!-- dodat u for each $event/$session etc -->
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <!-- REGISTER BTN -->
                                <a href="registrations/<?php echo $event->venue; //event_id?>"><button type="button" class="btn-blue mt-4"><span class="btn-blue-span">Register</span></button></a>
                            </div>
